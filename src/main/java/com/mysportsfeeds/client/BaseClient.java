...
import com.mysportsfeeds.client.exception.*;
...
public abstract class BaseClient {
    ...
    protected <T> T execute(String url, Class<T> responseType) throws MySportsFeedsException {
        ...
        try {
            ...
            throw new MySportsFeedsException(request, "Error occurred retrieving data", e);
        }
        ...
        try {
            ...
            throw new MySportsFeedsException(request, response, "Unable to parse response", e);
        }
    }
}
